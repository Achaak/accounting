...
const routesNames = {
  ...
  contacts:              'contacts',
    ...
    projectsUpdate: 'projects/update/:id',
    projectsInfo:   'projects/info/:id',
...
export const RoutesConfig: any = {
  ...
  routes: {
    ...
    contacts:              `/${routesNames.contacts}`,
      ...
      projectsNew:    `/${routesNames.projectsNew}`,
      projectsUpdate: `/${routesNames.projectsUpdate}`,
      projectsInfo:   `/${routesNames.projectsInfo}`,
      projectsList:   `/${routesNames.projectsList}`,
  }
};